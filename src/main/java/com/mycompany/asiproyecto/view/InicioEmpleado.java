...
public class InicioEmpleado extends javax.swing.JFrame {
    ...
    private void actualizarTablaPostulaciones(List<Postulacion> postulaciones) {
        ...
        for (Postulacion p : postulaciones) {
            ...
            row[0] = p.getNombreAlumno(); // "Nombre del candidato"
            row[1] = p.getPuestoPractica(); // "Puesto de práctica"
            row[2] = p.getFechaPostulacion().toString(); // "Fecha de postulación"
            row[3] = p.getEstado(); // "Estado"
            row[4] = "Ver CV/Portafolio"; // Placeholder visual
            row[5] = "Acciones"; // Placeholder visual
            model.addRow(row);
        }
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
                ...
                new String[] {
                        "Nombre del candidato", "Puesto de práctica", "Fecha de postulación", "Estado",
                        "Documento requerido", "Gestionar"
                }) {
