...
public class InicioEmpleado extends javax.swing.JFrame {
        ...
        private void initComponents() {
                ...
                modalidadComboBox
                                .setModel(new javax.swing.DefaultComboBoxModel<>(
                                                new String[] { "Presencial", "Virtual", "Híbrido" }));
                ...
                puestoComboBox.setModel(
                                new javax.swing.DefaultComboBoxModel<>(new String[] { "Otros", "Desarrollador Web",
                                                "Desarrollador Frontend", "Desarrollador Backend", "Programador Junior",
                                                "Practicante QA" }));

                javax.swing.GroupLayout informacionOfertaPanelLayout = new javax.swing.GroupLayout(
                                informacionOfertaPanel);
                informacionOfertaPanel.setLayout(informacionOfertaPanelLayout);
                informacionOfertaPanelLayout.setHorizontalGroup(
                                informacionOfertaPanelLayout
                                                ...
                                                .addGroup(informacionOfertaPanelLayout.createSequentialGroup()
                                                                .addGroup(informacionOfertaPanelLayout
                                                                                ...
                                                                                .addGroup(informacionOfertaPanelLayout
                                                                                                ...
                                                                                                .addComponent(modalidadComboBox,
                ...
                areaComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Todos", "Otros",
                                "Desarrollo Web",
                                "Desarrollo Movil", "Base de Datos", "Soporte TI", "Calidad de Software" }));

                puestoComboBox1
                                .setModel(new javax.swing.DefaultComboBoxModel<>(
                                                new String[] { "Todos", "Otros", "Desarrollador Web",
                                                                "Desarrollador Frontend", "Desarrollador Backend",
                                                                "Programador Junior", "Practicante QA" }));

                modalidadComboBox1.setModel(
                                new javax.swing.DefaultComboBoxModel<>(
                                                new String[] { "Todos", "Presencial", "Virtual", "Híbrido" }));
                ...
                jTable1.setModel(new javax.swing.table.DefaultTableModel(
                                ...
                                new String[] {
                                                "Nombre del candidato", "Puesto de práctica", "Fecha de postulación",
                                                "Estado",
                ...
                jLabel1.setIcon(
                                new javax.swing.ImageIcon(getClass()
                                                .getResource("/com/mycompany/asiproyecto/resources/icon2.png"))); // NOI18N

                jLabel2.setIcon(
                                new javax.swing.ImageIcon(getClass()
                                                .getResource("/com/mycompany/asiproyecto/resources/user.png"))); // NOI18N
    ...
    private void botonPublicarOfertaActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        private void configurarTabla() {
                ...
                // Configurar renderer para la columna "Evaluar" (índice 5)
                ...
                jTable1.addMouseListener(new MouseAdapter() {
                        ...
                        public void mouseClicked(MouseEvent e) {
                                ...
                                // Lógica para columna 5 (Evaluar)
                                else if (viewRow != -1 && viewColumn == 5) {
                                        evaluarPostulacion(viewRow);
                                }
                        }
                });
        ...
        private void evaluarPostulacion(int viewRow) {
                int modelRow = -1;
                try {
                        modelRow = jTable1.convertRowIndexToModel(viewRow);
                } catch (Exception ex) {
                ...
                if (modelRow >= 0 && modelRow < todasLasPostulaciones.size()) {
                        ...
                        Object[] options = { "Aceptar", "Rechazar", "Cancelar" };
                        int selection = javax.swing.JOptionPane.showOptionDialog(InicioEmpleado.this,
                                        "¿Desea aceptar o rechazar la postulación de " + p.getNombreAlumno() + "?",
                                        "Evaluar Postulación",
                        ...
                        if (selection == 0) { // Aceptar
                                nuevoEstado = "Aceptado";
                        } else if (selection == 1) { // Rechazar
                                nuevoEstado = "Rechazado";
                        }

                        if (nuevoEstado != null) {
                                boolean exito = InicioEmpleadoService.actualizarEstadoPostulacion(p.getIdPostulacion(),
                                                nuevoEstado);
                                if (exito) {
                                        javax.swing.JOptionPane.showMessageDialog(InicioEmpleado.this,
                                                        "Postulación marcada como " + nuevoEstado);
                                        // Actualizar caché y tabla
                                        todasLasPostulaciones.remove(modelRow);
                                        InicioEmpleadoService.actualizarTablaPostulaciones(todasLasPostulaciones,
                                                        InicioEmpleado.this);
                                } else {
                                        javax.swing.JOptionPane.showMessageDialog(InicioEmpleado.this,
        ...
        class ButtonRenderer extends JButton implements TableCellRenderer {
                ...
                public Component getTableCellRendererComponent(JTable table, Object value,
                        ...
                        setText((value == null) ? "Evaluar" : value.toString());
                        return this;
                }
        }
